...
content = content.replace(
    'BACKEND_URL = os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", "http://localhost:8000"))))',
    'BACKEND_URL = os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", "http://localhost:8000"))))'
)
...
import requests
import time
API_URL = os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", os.getenv("BACKEND_URL", "http://localhost:8000")))
